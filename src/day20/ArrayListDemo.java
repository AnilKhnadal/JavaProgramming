...
public class ArrayListDemo {
	...
	public static void main(String[] args) {
		...
		// List myslist=new ArrayList(); //child class object hold in th eparent class object
        // ArrayList<Integer> mylist=new ArrayList<Integer>(); //Only homogenious data stored <wrapper class only>
       // ArrayList<Employee> mylist=new ArrayList<Employee>(); // Employee objects only stored
	    ...
	    System.out.println("After replacing : "+mylist); // [100, 10.5, Java, Python, A, true, null, null, 200] - Jave replaced Python
	...
	/*    for(Object x:mylist)
	  ...
	  //  System.out.println(it.next());// it will print only first array only, so thats why we are using hasNext method.
	    
	  /*  while(it.hasNext()) // we dont know the how many object present in the array (if it is true)
	    {
